...
AbilityManager::AbilityManager() {
    addAbility(new BombardmentAbility());
    addAbility(new DoubleDamageAbility());
    addAbility(new ScannerAbility());
}
...
Ability* AbilityManager::first_ability() {
    if (abilities.empty() == true) {
        return nullptr;
    }
...
void AbilityManager::applyAbility(BattleMap& playerMap, BattleMap& botMap, ShipManager& playerShipManager, ShipManager& botShipManager) {
...
void AbilityManager::handleAbilityInput(BattleMap& playerMap, BattleMap& botMap, ShipManager& playerShipManager, ShipManager& botShipManager) {
    while (true) {
        ...
        if (toupper(useAbility) == 'Y') {
            applyAbility(playerMap, botMap, playerShipManager, botShipManager);
