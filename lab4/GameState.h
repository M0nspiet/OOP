...
class GameState {
public:
    GameState(const BattleMap& playerMap, const BattleMap& botMap, const ShipManager& playerShipManager, const ShipManager& botShipManager, Bot& bot)
        : playerMap(playerMap), botMap(botMap), playerShipManager(playerShipManager), botShipManager(botShipManager), bot(bot) {}
